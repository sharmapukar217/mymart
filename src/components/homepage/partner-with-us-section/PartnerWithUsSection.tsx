        ...
        <div className="space-y-6">
          ...
          <ul className="grid gap-4 max-w-sm">
            <li className="inline-flex items-center gap-2">
              <div className="size-8 bg-accent/80 text-accent-foreground rounded-xl flex items-center justify-center">
                <UserPlusIcon className="size-5" />
              </div>
              <span className="text-foreground/85 text-lg">
            ...
            <li className="inline-flex items-center gap-2">
              <div className="size-8 bg-accent/80 text-accent-foreground rounded-xl flex items-center justify-center">
                <ClockArrowUpIcon className="size-5" />
              </div>
              <span className="text-foreground/85 text-lg">
